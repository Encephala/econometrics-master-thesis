...
# Drop non-numeric
data_2018 = data_2018.loc[:, data_2018.dtypes == "float64"].drop(columns=["184", "185", "186", "187", "188", "193"])
data_2024 = data_2024.loc[:, data_2024.dtypes == "float64"].drop(columns=["184", "185", "186", "187", "188", "193"])
