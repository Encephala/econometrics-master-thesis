...
mhi5_years = [f"20{year:02d}" for year in list(available_waves(mhi5))]
...
plt.ylabel("MHI5")
plt.xlabel("Year")
xticks = [f"20{year:02d}" for year in range(8, 24, 2)]
plt.xticks(list(range(8, 24, 2)), labels=xticks, rotation=90)  # pyright: ignore  # noqa: PGH003
...
plt.xlabel("Year")
plt.xticks(list(range(8, 24, 2)), xticks, rotation=90)
