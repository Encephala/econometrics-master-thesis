...
Do note that in a regression context, in order for the effect of SPORTS$_{t-1}$ to be identifed with respect to the simultaneous
...
% TODO: use fixed/nonfixed rather than endo/exo
