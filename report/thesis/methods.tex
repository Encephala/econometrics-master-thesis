...
regresson of $y = \alpha + \beta_1 x_1 + \beta_2 x_2 + \epsilon$. From this equation, the model-implied covariance between $y$
and $x_1$ can be readily defined in terms of the regressor covariances as
$\text{Cov}(y, x_1) = \beta_1 \Sigma_{x_1} + \beta_2 \Sigma_{x_1 x_2}$, where $\Sigma_{x_1}$ denotes the variance of $x_1$
and $\Sigma_{x_1 x_2}$ denotes the covariance between $x_1$ and $x_2$.
Estimating covariance elements of $\Sigma$ thus corresponds directly to estimating a regression equation.
To be precise, the diagonal elements of $\Sigma$ are estimated directly as well as the covariance elements between
the regressors, at which point estimating the above regression equation as compared to estimating the remaining elements
of $\Sigma$ directly is just a matter of reparametrisation; the two models are completely equivalent.
