...
The exact set of variables used will be determined in \Cref{sec:modelling:regressors}.
For the variables that are ultimately selected, the official descriptions can be found in \Cref{chap:app:liss_questions},
...
\begin{figure}[htbp]
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \vspace{0.1em}
        \subcaption{Boxplot of the MHI5 score. Whiskers are 10th and 90th percentiles.
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \vspace{0.1em}
        \subcaption{Rate of engagement in exercise}
...
the reason for its absence is not known, the same likely holds for the missing Health panel wave of 2014.
