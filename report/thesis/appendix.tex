...
\end{equation}
Without loss of generality, controls are left out for simplicity.
...
\end{equation}
Thus, if a binary variable $x_{it}$ changes from 0 to 1, the equilibrium value of $y_{it}$ changes by
\begin{equation}
