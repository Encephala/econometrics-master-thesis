...
\begin{table}[htbp]
    ...
    Estimates are changes in mean MHI5 scores (except for the AR estimates),
    with respect to the dummy level in parentheses where applicable.
...
as they alter estimations of the parameters of interest (\Cref{tab:results:mediation_regression}),
...
\begin{table}[htbp]
    ...
    Estimates are increases in mean MHI5 scores with respect to the dummy level in parentheses.
    Fit indices are robust where applicable}
...
It is always a possibility that the absence of a strong long-term effect is due to various imperfections
...
It appears more worthwhile for retrospective observational studies to be focused on Granger causality, which should be
combined with mechanistic research and randomised controlled trials for a better means to discover causality.
