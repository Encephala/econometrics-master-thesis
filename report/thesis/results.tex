...
long-term benefit of exercise on mental health. Second, the complex model design combined with the quality issues
in the data obscure many of the effects of exercise that are very much of real-world interest.
...
However, there is an extensive literature on the persistency of benefits of exercise on cognition, referred to as
cognitive reserve \cite{cheng2016cognitive,stern2009cognitive}, so the prior interpretation is favoured.
While this finding is consistent with some literature which find no strong benefit (e.g. \cite{chalder2012facilitated}),
it stands in stark contrast with other research (e.g. \cite{philippot2022impact}) and even with this extensive literature
...
relevant mediators and outcomes, as well as close attention paid to avoiding missingness.
However, absence of a long-term effect also informs an emphasis in future research on the short-term effect, noting
the instantaneous association in \cref{tab:results:mediation_regression} are consistently larger than the lagged effects.
